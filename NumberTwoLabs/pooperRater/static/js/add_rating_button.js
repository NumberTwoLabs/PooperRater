...
var AddRatingButton = React.createClass({
  render: function() {
    ...
    return <button type="submit" className="btn btn-lg btn-warning col-lg-12 col-sm-12 col-xs-12 btn-block" placeID= {this.props.placeID}>Want to Add a Rating</button>;
  }
});
